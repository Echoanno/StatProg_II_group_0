...
age_data %>%
  ...
  arrange(AUSPRAEGUNG) %>%
 kable(caption = "Summary of age-group observations, missing values and time coverage.")
```
...
#| fig-cap: "Age structure of Munich's population in selected years. The bars show the relative shares of constructed non-overlapping age groups in 2000, 2010, 2020 and 2024."
...
#| fig-cap: "Population trends by age group in Munich. Each panel shows yearly mean population for one constructed age group from 2000 to 2024."
...
age_change_table %>%
  ...
  kable(caption = "Population change by constructed age group between 2000 and 2024.")
```
...
#| fig-cap: "Migration dynamics in Munich. The lines show yearly averages of monthly arrivals, departures and net migration from 2000 to 2024."
...
#| fig-cap: "Net migration balance in Munich. The orange line shows the 3-year rolling average from 2000 to 2024."
...
```{r}
#| label: fig-eu-non-eu
#| fig-cap: "EU and non-EU populations in Munich. The lines compare yearly mean population levels for EU and non-EU citizens from 2000 to 2024."
...
#| fig-cap: "Population by continental group in Munich. Each panel shows yearly mean population for one continental group from 2000 to 2024."
...
#| fig-cap: "Indexed age-structure and migration indicators in Munich. All indicators are scaled to 2000 = 100 to compare relative changes over time."
...
#| fig-cap: "Household structure in Munich by household size. The lines show each household-size category's share of total households from 2012 to 2024."
...
#| fig-cap: "Change in household-size shares in Munich. The bars show percentage-point changes by household-size category between 2012 and 2024."
...
#| fig-cap: "Grouped household structure in Munich. The lines show the shares of one-person, two-person and three-or-more-person households from 2012 to 2024."
